...
│          [+] Added Url Parser               │
├─────────────────────────────────────────────┤
│Have any question DM owner T00LS!
├─────────────────────────────────────────────┤
│ Discord Owner T00L$ : ZyinX#8885     
│(Note: Owner slow res if busy.)
└─────────────────────────────────────────────┘''')
print("Notepad: Don't leak this T00L$ please!.")
print("Notepad²: Re-name use credit!")
...
print("[ > ] Btw im not iYoonih, im diffrent!")
uid = input('Username : ')
print("[ ! ] Password Is Cencored, Sorry :(")
pwd = getpass.getpass('Password : ******* ')
if uid == userid and pwd == passw :
    print("[ + ] Welcome To my Premium Tools!.")
